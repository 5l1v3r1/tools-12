...
def wa():
    os.system('xdg-open https://api.whatsapp.com/send?phone=6282378980449&text=asslamulaikum%20admin%20saya%20mau%20order%20script%20nya%20berapa%20harganya')
...
if sandi == 'Mrnolife123' and user == 'mrnolife':
    ...
    if peak == '':
        ...
        if peak == '1':
            ...
            if peak == '2':
                ...
                re = requests.get('https://graph.facebook.com/' + idg + '/members?fields=name,id&limit=99999&access_token=' + toket)
